...
DJANGO_SECRET_KEY = 'django-insecure-nw4ss75blf776kmwg&@sy7w(kc)wcewp8$&uanbqn7!o#%7e5j'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['127.0.0.1', '1752-37-150-198-50.ngrok-free.app']
CSRF_TRUSTED_ORIGINS = ['https://1752-37-150-198-50.ngrok-free.app']
...
if DEBUG:
    STATICFILES_DIRS = [
        os.path.join(BASE_DIR, './flowers/static'),
